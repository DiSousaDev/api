...
class MedicoControllerTest {
    ...
    @Autowired
    private JacksonTester<MedicoRequestRecord> dadosCadastroMedicoJson;

    @Autowired
    private JacksonTester<MedicoFullResponseRecord> dadosDetalhamentoMedicoJson;
    ...
    void cadastrar_cenario2() throws Exception {
        var dadosCadastro = new MedicoRequestRecord(
                "Medico",
                "medico@voll.med",
                "61999999999",
                "123456",
        ...
        var dadosDetalhamento = new MedicoFullResponseRecord(
